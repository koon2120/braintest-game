  ...
  <div class="container mx-auto font-sans">
    <div class="flex flex-col justify-center items-center h-screen gap-3">
      ...
      <div class="bg-zinc-200 p-5 m-5 rounded-lg lg:w-1/2">
        ...
        <p>สำหรับวิธีการเล่นนั้นง่ายมากๆ เพียงแค่คุณจำตัวเลขบนหน้าจอแล้วกด "ต่อไป" เพื่อรับเลขถัดไปมาแสดงผลและจำตัวเลขเหล่านี้ไปเรื่อยจนกว่าจะครบ 10 ตัวเลข เมื่อครบแล้วคุณจะได้รับคำถามอย่างเช่น "หมายเลขที่ 5 คือเลขอะไร?" คุณจะต้องตอบให้ถูกต้อง!</p>
      </div>
    </div>
  </div>
